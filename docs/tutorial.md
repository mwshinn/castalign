...
|-------------------------------|------|---------|------------|-------------|------------|--------|-----------------------------------------------------------------------------------|
| Identity                      | X    | X       | X          |             | X          | X      | Do nothing                                                                        |
| Translate                     | X    | X       | X          | X           | X          | X      | Translation                                                                       |
| TranslateFixed                | X    | X       | X          |             | X          | X      | Translation                                                                       |
| TranslateRotate               | X    | X       | X          | X           | X          | X      | Translation and rotation                                                          |
| TranslateRotateFixed          | X    | X       | X          |             | X          | X      | Translation and rotation                                                          |
| TranslateRotateRescale        | X    | †       |            | X           | X          | X      | Translation, rotation, rescaling                                                  |
| TranslateRotateRescaleByPlane |      | X       | X          | X           | X          | X      | Translation, rotation, rescaling, independently for lowest-variance dimension     |
| TranslateRotateRescaleFixed   | X    | X       | X          |             | X          | X      | Translation, rotation, rescaling                                                  |
| FlipFixed                     | X    | X       | X          |             | X          | X      | Flip across an axis                                                               |
| ShearFixed                    | X    | X       | X          |             | X          | X      | Apply shear along a plane                                                         |
| MatrixFixed                   | X    | X       | X          |             | X          | X      | Directly enter an augmented matrix                                                |
| Rescale                       | X    | X       | X          |             | X          | X      | Rescale, i.e. downsample or upsample (lossless)                                   |
| Triangulation                 | X    |         |            | X           | X          |        | Perform piecewise affine transforms between a triangulation of the control points |
| Triangulation2D               |      | X       | ‡          | X           | X          |        | Project to a 2D space, perform piecewise 2D transforms, and then return to 3D     |
| DistanceWeightedAverage       | X    | X       |            | X           |            |        | Compute a displacement field as a distance weighted average of control points     |
